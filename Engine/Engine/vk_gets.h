...
namespace Vulkan
{
	...
	[[nodiscard]] VkFormat getSupportedFormat(const VkPhysicalDevice a_device, const std::vector<VkFormat>& a_formats, const VkImageTiling a_tiling, const VkFormatFeatureFlags a_featureFlag);
	[[nodiscard]] VkFormat getSupportedFormat(const VkPhysicalDevice a_device, std::vector<VkFormat>&& a_formats, VkImageTiling&& a_tiling, VkFormatFeatureFlags&& a_featureFlag);
